...
public class CraftingEncodingPanel extends DiskEncodingModePanel {
    ...
    public CraftingEncodingPanel(PatternDiskEncodingTermScreen screen, WidgetContainer widgets) {
