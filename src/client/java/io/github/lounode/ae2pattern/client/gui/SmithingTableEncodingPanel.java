...
public class SmithingTableEncodingPanel extends DiskEncodingModePanel {
    ...
    public SmithingTableEncodingPanel(PatternDiskEncodingTermScreen screen, WidgetContainer widgets) {
